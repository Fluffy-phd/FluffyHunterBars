...
local function update_spell_finished(spellID)
	...
	elseif isSpellAnAbility(spellID, fluffy.ability_autoshot) then
		local speed, _, _, _, _, _ = UnitRangedDamage("player");
		fluffy.ability_autoshot["fired"] = t;
		fluffy.ability_autoshot["next_start"] = fluffy.ability_autoshot["fired"] + speed - fluffy.ability_autoshot["cast"](fluffy.ability_autoshot["fired"]);
		fluffy.ability_autoshot["next_fired"] = fluffy.ability_autoshot["fired"] + speed;
